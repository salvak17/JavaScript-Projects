...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is used to check each element of selected Square... 
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //squareNumber and activePlayer are concatnated together and added to array.
        ...
        if(activePlayer === 'O') {
            ...
            //...placing the image and enabling click.
    ...
    function computersTurn() {
        ...
        let success = false;
        //This variable sstores a random number 0-8
        let pickASquare;
        ...
        while(!success) {
            ...
            //If the random number evaluates returns tre, the square hasn't been selected yet.
            if (placeXOrO(picASquare)) {
...
function checkWinConditions() {
    ...
    // X 6, 4, 2 condition
    else if (arrayIncludes('0X', '3X', '6X')) { drawWinLine(100, 508, 510, 90); }
    // X 0, 4, 8 condition
    ...
    // O 6, 4, 2 condition
    else if (arrayIncludes('0O', '3O', '6O')) { drawWinLine(100, 508, 510, 90); }
    // O 0, 4, 8 condition
...
// This function takes a string parameter of the path you...
// ...set earlier for placement sound ('./media/place.mp3')
function audio(audioURL) {
    //We create a new audio object and we pass the path as a parameter.
    let audo = new Audio(audioURL);
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //This line indicates where the end of a lin's x axis is.
        x2 = coordX2,
